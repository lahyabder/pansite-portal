                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <div className="bg-white rounded-2xl p-6 border border-pan-gray-100">
                                <h3 className="font-semibold text-pan-navy mb-4 text-sm uppercase tracking-wider">
                                    {locale === 'ar' ? 'معلومات الاتصال' : 'Coordonnées'}
                                </h3>
                                <ul className="space-y-4 text-sm text-pan-gray-600">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <div className="font-medium text-pan-navy">{locale === 'ar' ? 'العنوان' : 'Adresse'}</div>
                                    ...
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <div className="font-medium text-pan-navy">{locale === 'ar' ? 'الهاتف' : 'Téléphone'}</div>
                            ...
                            <div className="bg-pan-gray-200 rounded-2xl h-48 flex items-center justify-center">
                                <span className="text-pan-gray-500 text-sm">{locale === 'ar' ? 'خريطة الموقع' : 'Carte — Nouadhibou'}</span>
                            </div>
                        </div>
                    </div>
                </div>
