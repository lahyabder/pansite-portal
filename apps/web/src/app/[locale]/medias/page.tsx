...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    const descriptions = {
        ...
        en: "Dive into the media library of the Port Autonome de Nouadhibou (PAN). Discover our photo and video galleries illustrating the dynamism of our port activities.",
