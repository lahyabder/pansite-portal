...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    const descriptions = {
        ...
        en: "Welcome to the Autonomous The Port of Nouadhibou, Mauritania's strategic maritime and logistics hub offering world-class port services.",
...
export default async function HomePage({
    ...
    return (
        <div className="relative">
            <h1 className="sr-only">{dict.hero.title || 'Port Autonome de Nouadhibou (PAN)'}</h1>
