...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    const descriptions = {
        ...
        en: "Explore the modern infrastructures of the Autonomous The Port of Nouadhibou: commercial quays, oil terminal, and cutting-edge equipment for your vessels.",
