...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    const descriptions = {
        ...
        en: "Stay informed about the latest calls for tenders, consultations, and public contracts issued by the Autonomous The Port of Nouadhibou for its development.",
