  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-black text-slate-900 font-outfit">Actualités & Contenus</h1>
          <p className="text-slate-500 mt-2">Publiez et gérez les actualités, communiqués et événements.</p>
        </div>
        <Link 
          href="/contents/create"
          className="flex items-center gap-2 bg-sky-500 hover:bg-sky-400 text-slate-900 px-6 py-3 rounded-2xl font-black text-sm transition-all"
        >
                ...
                <tr key={item.id} className="hover:bg-white/[0.02] transition-colors group">
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-sm font-bold text-slate-900 line-clamp-1">{item.title?.fr || item.slug}</p>
                        <p className="text-xs font-mono text-slate-500 mt-1">/{item.slug}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-5">
                    <span className="uppercase text-[10px] font-black text-slate-500 tracking-widest">{item.category}</span>
                  </td>
                  <td className="px-6 py-5">
                  ...
                  <td className="px-6 py-5 text-right">
                    <Link 
                      ...
                      className="inline-flex items-center justify-center p-2 rounded-lg bg-gray-100 hover:bg-sky-500 hover:text-slate-900 text-slate-500 transition-colors"
                    >
